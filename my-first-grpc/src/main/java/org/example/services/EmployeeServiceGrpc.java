...
public final class EmployeeServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.services.EmployeeRequest,
      org.example.services.EmployeeResponse> getGetEmployeeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getEmployee",
      requestType = org.example.services.EmployeeRequest.class,
      responseType = org.example.services.EmployeeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.services.EmployeeRequest,
      org.example.services.EmployeeResponse> getGetEmployeeMethod() {
    io.grpc.MethodDescriptor<org.example.services.EmployeeRequest, org.example.services.EmployeeResponse> getGetEmployeeMethod;
      ...
      synchronized (EmployeeServiceGrpc.class) {
        if ((getGetEmployeeMethod = EmployeeServiceGrpc.getGetEmployeeMethod) == null) {
          EmployeeServiceGrpc.getGetEmployeeMethod = getGetEmployeeMethod = 
              io.grpc.MethodDescriptor.<org.example.services.EmployeeRequest, org.example.services.EmployeeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "example.EmployeeService", "getEmployee"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.services.EmployeeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.services.EmployeeResponse.getDefaultInstance()))
  ...
  public static abstract class EmployeeServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getEmployee(org.example.services.EmployeeRequest request,
        io.grpc.stub.StreamObserver<org.example.services.EmployeeResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.example.services.EmployeeRequest,
                org.example.services.EmployeeResponse>(
  ...
  public static final class EmployeeServiceBlockingStub extends io.grpc.stub.AbstractStub<EmployeeServiceBlockingStub> {
    ...
    /**
     */
    public org.example.services.EmployeeResponse getEmployee(org.example.services.EmployeeRequest request) {
  ...
  public static final class EmployeeServiceFutureStub extends io.grpc.stub.AbstractStub<EmployeeServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.services.EmployeeResponse> getEmployee(
        org.example.services.EmployeeRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EMPLOYEE:
          serviceImpl.getEmployee((org.example.services.EmployeeRequest) request,
              (io.grpc.stub.StreamObserver<org.example.services.EmployeeResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EmployeeServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.services.Employee.getDescriptor();
    }
